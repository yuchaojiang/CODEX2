...
**Demo code** for CODEX2 can be found [here](https://github.com/yuchaojiang/CODEX2/blob/master/demo/), with spike-in demo dataset pre-stored with CODEX2's R-pacakge. **Update 12/18/2017**: We are still pushing constant updates to the package and are working on releasing the final version with vignettes. We will submit the package to CRAN/Bioconductor and update this page as soon as it is available .
